...
{   
    if(task == 3 || task == 4){
        ...
        if( task == 4 && (abs(texture(texDepth, texCoord).x - topLeftCoord)>0.0002 || abs(texture(texDepth, texCoord).x - topRightCoord)>0.0002 || abs(texture(texDepth, texCoord).x - bottomLeftCoord)>0.0002 || abs(texture(texDepth, texCoord).x - bottomRightCoord)>0.0002 )){
